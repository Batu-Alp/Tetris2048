...
def start():
   ...
   current_tetromino = create_tetromino(grid_h, main_w)

   #next_tetro = tetro_list[tetro_count + 1]
   #next_tetro.move_pos(15, 15)
...
def gameOver(grid_height, grid_width, background_color, button_color, text_color, img_file, grid):
...
def pauss(button_color,img_center_x,button_w, button_blc_x, button_blc_y, button_h, text_color, grid_width, grid_height, grid):
