...
class Tetromino:
   ...
   """
   def get_tetromino_points(self, game_grid, current_tetromino):
   ...
   """
   # 90 degree rotation
   def get_tetromino_points(self, current_tetromio):
      n = len(self.tile_matrix)
